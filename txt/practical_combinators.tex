...
The identity combinator \texttt{I} is conventionally written \texttt{Ix = x}.  This simply means that it returns the result of its evaluation unchanged.
...
\subsection{\texttt{I} Identity = Opcode 0}
...
\subsection{\texttt{K} Constant = Opcode 1}

\subsection{\texttt{S} Substitution = Opcode 2}
...
\subsection{\texttt{C} Reversal}

C = S (S (K (S (K S) K)) S) (K K)

In Nock, the reversal combinator \texttt{C} is almost free due to the binary tree nature of cells.
